...
export class QuizcontentsService {
	...
	gk_content:Quizformat[] = [
		...
		{
			qid:"2",
			qtext:"20th August is celebrated as ",
			op1:"Earth Day",
			op2:"Sadbhavana Diavs",
			op3:"No Tobbcco day",
			op4:"None of these",
			ans:"Sadbhavana Diavs"
		},
		{
			qid:"3",
		...
		{
			qid:"4",
			qtext:"When is the World Population Day observed",
			op1:"May 31",
			op2:"October 4",
			op3:"December 10",
			op4:"July 11",
		...
		{
			qid:"6",
			qtext:"January 15 is celebrated as the",
			op1:"Republic Day",
			op2:"Ugadhi",
			op3:"Teachers' Day",
			op4:"Army Day",
